-- Shared constants for ConsoleToolkit modules.

ConsoleToolkit = ConsoleToolkit or {}
ConsoleToolkit.constants = ConsoleToolkit.constants or {}

ConsoleToolkit.constants.companions = {
...
constants = ConsoleToolkit.constants
